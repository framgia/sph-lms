              ...
              <table className="mt-4">
                <thead>
                  <tr className="">
                    ...
                    <th className="bg-lightGray2 py-[16px] text-[14px] text-lightGray3 font-[500] leading-[21px]">
                      First Name
                    </th>
                    <th className="bg-lightGray2 py-[16px] text-[14px] text-lightGray3 font-[500] leading-[21px] rounded-tr-md">
                      Last Name
                    </th>
                  </tr>
                </thead>
