        ...
        <div>
          ...
          <Table header={headers}>
            {dummyData.length > 0 ? (
              ...
              <tr>
                <td colSpan={headers.length + 1} className="text-center pt-10 font-bold">
...
const dummyData = [
  {
    ...
    type: 'YouTube',
    description: 'Lorem ipsum, dolor sit amet consectetur adipisicing elit. Possimus, repudiandae.',
    directory: 0,
