      ...
      <Container>
        <div className=" flex flex-col">
          <div className="flex flex-row justify-between">
            <div className="text-3xl flex justify-start pb-10 pt-5 text-lightBlue">Users</div>
            <UserCreate />
          </div>
          ...
          <div className="h-96">
              ...
              {Array.isArray(listOfUser) && listOfUser.length > 0 ? (
                listOfUser.map((col: any) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4 text-lightBlue underline">{col.username}</td>
            ...
            <div className="flex flex-row justify-between pt-10 pb-10">
              ...
              <div className="flex items-center">
                Showing {startingIndex} to {lastIndex} of {numberOfUsers} entries |
              </div>
            </div>
